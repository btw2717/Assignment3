...
public class AddQuiz extends Application {
	...
	/**
	 * the main() method is just a backup because this is a javafx application.
	...
	/**
	 * the start() method initializes the javafx application and executes the gui functions.
	 * @param primaryStage creates the primary stage which the scene gets set to.
	 */
	public void start(Stage primaryStage) {
		...
		intro.setContentText("Hello there, I am going to generate 3 random integers, and you can try to add them. Let's see how good your math skills are.");
		intro.showAndWait();
